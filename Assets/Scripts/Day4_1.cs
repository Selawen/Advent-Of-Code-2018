...
public class Day4_1 : MonoBehaviour
{
    ...
    private Dictionary<DateTime, bool?[]> sleptMinutesOnDate; 
    private Dictionary<DateTime, bool?[]> sleptAtMinutesOnDate; 
    private Dictionary<int, int> sleptMinutesPerGuard; 
